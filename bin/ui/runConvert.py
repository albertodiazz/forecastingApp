...
def run():
    ...
    save.conversionChartsImagenes().saveImage(chartPercent_Assets_CRYPTO,'chartPercent_Assets_CRYPTO')

    chartPercentInversores = charts.chartPercentInversores(porcentajeInversionistas)
    save.conversionChartsImagenes().saveImage(chartPercentInversores,'chartPercentInversores')
    

    chartMonedasTradeadas = charts.chartMonedasTradeadas(movimientos_comisiones)
    save.conversionChartsImagenes().saveImage(chartMonedasTradeadas,'chartMonedasTradeadas')
    
    chartBalanceUSDT = charts.chartBalanceUSDT(movimientos_comisiones)
    save.conversionChartsImagenes().saveImage(chartBalanceUSDT,'chartBalanceUSDT')
